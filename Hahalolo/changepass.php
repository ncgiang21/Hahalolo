          ...
          <div class="row">
            ...
            <div class="col-md-6 contents">
              <div class="row justify-content-center">
                ...
                <form action="process-changepass.php" method="post" name="frmChangepass" autocomplete>     
                  ...
                  <input type="submit" name = "btnChange" value="Đổi Mật Khẩu" class="btn btn-block btn-primary justify-content-center mt-3 mb-4">
