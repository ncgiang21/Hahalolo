              ...
              <div class="row justify-content-center">
                ...
                <form action="process-register.php" method="post">
                  ...
                  <div class="form-group first mb-2 bg-white" style="border: 1px solid gray; border-radius: 5px;">
                    <input type="text" class="form-control" id="username" placeholder="Họ và tên" required>
                  ...
                  <div class="form-group last mb-4 bg-white" style="border: 0.5px solid gray; border-radius: 5px;">
                    <input type="password" class="form-control" id="password" placeholder="Nhập lại mật khẩu" required>                
                  </div>

                  <input type="submit" value="Đăng Ký" class="btn btn-block btn-primary justify-content-center mt-3 mb-4">
